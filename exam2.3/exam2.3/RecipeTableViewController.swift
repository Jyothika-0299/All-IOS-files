...
class RecipeTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Veg = ["Panner","Brinjal","Mushroom"]
        VegImages = ["panner","brinjal","mushroom"]
        RecipeDetails = ["paneer.txt","brinjal.txt","mushroom.txt"]
 
        
        
        NonVeg = ["Mutton","Fish","Chicken"]
        NonVegImages = ["mutton","fish","chicken"]
        NonRecipeDetails = ["mutton.txt","fish.txt","chicken.txt"]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let nextScreen = storyboard.instantiateViewController(withIdentifier: "storyid1") as! RecipeDetailsViewController
