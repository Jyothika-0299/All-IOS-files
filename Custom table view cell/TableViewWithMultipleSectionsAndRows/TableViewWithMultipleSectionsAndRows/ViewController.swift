...
class ViewController: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell1.l1.text = Section1Names[indexPath.row]
            cell1.img1.image = UIImage(named: Section1Images[indexPath.row])
            ...
            cell2.l1.text = Section2Names[indexPath.row]
            cell2.img1.image = UIImage(named: Section2Images[indexPath.row])
